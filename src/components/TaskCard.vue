<template>
  <div
    class="modal fade show d-block z-2 bg-dark bg-opacity-50 d-flex align-items-center"
      ...
      <div class="container" @click.stop v-if="!editMode">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <button
              v-if="canEditTask(task.groupName)"
      ...
      <div class="container" @click.stop v-else>
        <form class="card p-5">
          ...
          <div class="mb-3">
            ...
            <textarea v-model="description" class="form-control" id="exampleInputPassword1" />
          </div>
